...
-- CreateIndex
CREATE UNIQUE INDEX "availability_calendar_listingId_date_key" ON "availability_calendar"("listingId", "date");
...
-- AddForeignKey
ALTER TABLE "availability_calendar" ADD CONSTRAINT "availability_calendar_listingId_fkey" FOREIGN KEY ("listingId") REFERENCES "Listing"("id") ON DELETE CASCADE ON UPDATE CASCADE;
